                ...
                <div class="col-xl-2 col-lg-2 col-md-6">
                    <div class="headerarea__left">
                        <div class="headerarea__left__logo">
                            ...
                            <a href="index.html">
                                <img loading="lazy" style="height:60px" src="{{asset('assets/media/logos/Maths-house.png')}}" alt="logo">
                                <span>
                                    MathHouse
                                </span>
                            </a>
                        ...
                        <nav>
                            <ul>
                                ...
                                <li class="mega__menu position-static">
                                    <a class="headerarea__has__dropdown" href="{{route('stu_profile')}}">
                                        Profile 
                                    </a>
                                </li>

                                <li class="mega__menu position-static">
                                    <a class="headerarea__has__dropdown" href="{{route('stu_my_courses')}}">
                                        My Courses
                                    </a>
                                </li>
