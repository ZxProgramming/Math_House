    ...
    <table id="kt_profile_overview_table"
        ...
        <thead class="fs-7 text-gray-500 text-uppercase">
            <tr>
                ...
                <th class="min-w-150px sorting" tabindex="0" aria-controls="kt_profile_overview_table" rowspan="1"
                    colspan="1" aria-label="Date: activate to sort column ascending" style="width: 205.188px;">Email
                </th>
                <th class="min-w-150px sorting" tabindex="0" aria-controls="kt_profile_overview_table" rowspan="1"
                    colspan="1" aria-label="Date: activate to sort column ascending" style="width: 205.188px;">Parent
                    Phone</th>
                <th class="min-w-150px sorting" tabindex="0" aria-controls="kt_profile_overview_table" rowspan="1"
                    colspan="1" aria-label="Date: activate to sort column ascending" style="width: 205.188px;">Parent
                    Email</th>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="my-2 px-3">
                                                ...
                                                <input class='form-control' name="parent_phone"
                                                    value="{{ $item->parent_phone }}" placeholder="Parent Phone" />
                                            </div>
                                            ...
                                            <div class="my-2 px-3">
                                                ...
                                                <input class='form-control' name="parent_email"
                                                    value="{{ $item->parent_email }}" placeholder="Parent E-mail" />
                                            </div>
