...
<x-default-layout>
    ...
    <table id="kt_profile_overview_table"
        ...
        <thead class="fs-7 text-gray-500 text-uppercase">
            <th class="min-w-250px sorting sorting_desc text-center" tabindex="0" aria-controls="kt_profile_overview_table"
            ...
            <th class="min-w-150px sorting" tabindex="0" aria-controls="kt_profile_overview_table" rowspan="1"
                colspan="1" aria-label="Date: activate to sort column ascending" style="width: 205.188px;">Category
            </th>
            <th class="min-w-150px sorting" tabindex="0" aria-controls="kt_profile_overview_table" rowspan="1"
                colspan="1" aria-label="Date: activate to sort column ascending" style="width: 205.188px;">Course
            </th>
            <th class="min-w-150px sorting" tabindex="0" aria-controls="kt_profile_overview_table" rowspan="1"
                colspan="1" aria-label="Date: activate to sort column ascending" style="width: 205.188px;">Chapter
            </th>
            <th class="min-w-150px sorting" tabindex="0" aria-controls="kt_profile_overview_table" rowspan="1"
                ...
                <tr>
                    ...
                    <td>
                        <div class="mt-3">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content px-2">
                                            ...
                                            <div class="info_section" id="info_section{{ $lesson->id }}">
                                                ...
                                                <input value="{{ $lesson->id }}" type="hidden"
                                                    name="lesson_id" />
                                            ...
                                            <div class="priceing_section d-none"
                                                ...
                                                @foreach ($lesson->ideas as $idea)
                                                    <div class='my-3'>
                                                        <label>Idea</label>
                                                        <input class='form-control' value="{{ $idea->idea }}"
                                                            name="idea[]" placeholder="Idea" />
                                                    </div>
                                                    <div class='my-3'>
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="modalDelete{{ $lesson->id }}" tabindex="-1"
                                aria-hidden="true" style="display: none;">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                            ...
                            <div class="current" data-kt-stepper-element="content">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="pb-10 pb-lg-15">
                                        <!--begin::Title-->
                                        <h2 class="fw-bold d-flex align-items-center text-gray-900">Information About
                                            Lesson Details
                            ...
                            <div data-kt-stepper-element="content">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="d-flex flex-column mb-5 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <textarea class="form-control form-control-solid" rows="3" name="pre_requisition"
                                            placeholder="Pre requisition"></textarea>
                                        <!--end::Input-->
                                    </div>
                            ...
                            <div data-kt-stepper-element="content">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="pb-10 pb-lg-12">
                                        ...
                                        <!--end::Title-->
                                        <!--begin::Description-->
                                        <div class="text-muted fw-semibold fs-2 d-flex align-items-center">If you need
